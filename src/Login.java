...
public class Login extends javax.swing.JFrame {
    ...
    void login()
    {
        ...
        {
            try {
                    DBConnect.checkAdmin.setString(1, s2);
                    DBConnect.checkAdmin.setString(2, s3);
                    ResultSet rs= DBConnect.checkAdmin.executeQuery();
                    if(rs.next())
                    {
                        this.dispose();
        ...
        else
        {
            ...
            try 
            {
                DBConnect.checkEmp.setString(1, s2);
                DBConnect.checkEmp.setString(2, s3);
                ResultSet rs= DBConnect.checkEmp.executeQuery();
                if(rs.next())
                {

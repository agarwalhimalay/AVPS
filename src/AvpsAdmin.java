...
public class AvpsAdmin extends javax.swing.JFrame {
    ...
    private void pButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pButtonActionPerformed
        ...
        if(!vn.equals(""))
        {
            ...
            try 
            {
                ResultSet rs1=DBConnect.st.executeQuery("select MAX(SlipNo) from Parking");
                if(rs1.next())
                ...
                while(rs.next())
                {
                    ...
                    {
                        f=rs.getString(2);
                        DBConnect.st.executeUpdate("insert into Parking values("+slipNo+",'"+vt+"','"+vn+"',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'"+f+"',0,'Present')");
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        try
        {
            DefaultTableModel dtm=(DefaultTableModel)mresultTable.getModel();
            int rc=mresultTable.getRowCount();
            while(rc--!=0){
                dtm.removeRow(0);
            }
